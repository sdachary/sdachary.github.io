...
// re-warms first (8s budget) then probes (extra per-check execSync window).
    ...
    { id: 'chitragupta', url: 'https://chitragupta.vayalabs.in' },
    { id: 'bepara',      url: 'https://bepara.vayalabs.in' },
    { id: 'udhyam',      url: 'https://udhyam.vayalabs.in' },
    { id: 'sampada-web', url: 'https://sampada.vayalabs.in' },
    { id: 'sadhan',      url: 'https://sadhan.vayalabs.in' },
    { id: 'nidhiflow',   url: 'https://nidhiflow.pages.dev' },
    { id: 'vishwakarma', url: 'https://vishwakarma.vayalabs.in' },
    { id: 'darpan',      url: 'https://darpan.vayalabs.in' },
    { id: 'prayog',      url: 'https://prayog.vayalabs.in' },
